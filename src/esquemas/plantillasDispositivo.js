...
const esquemaCrearPlantilla = z.object({
  ...
  funcionalidades: z.record(z.string(), z.unknown()).optional(),
  etiquetas_bits: z.record(z.string(), z.unknown()).optional(),
...
const esquemaMigrarPlantillas = z.object({
  plantillas: z.array(z.record(z.string(), z.unknown())).min(1, 'Se requiere al menos una plantilla'),
  tipo_dispositivo: z.enum(['rele', 'analizador'], {
    errorMap: () => ({ message: 'Tipo inválido. Debe ser: rele o analizador' }),
  }),
});
